  ...
  return new cloudfront.ResponseHeadersPolicy(scope, "FrontendResponseHeadersPolicy", {
    ...
    securityHeadersBehavior: {
      contentSecurityPolicy: {
        contentSecurityPolicy: [
          "default-src 'self'",
          "script-src 'self' https://cdn.jsdelivr.net https://www.youtube.com https://www.youtube-nocookie.com https://www.dailymotion.com https://*.dmcdn.net https://pagead2.googlesyndication.com",
